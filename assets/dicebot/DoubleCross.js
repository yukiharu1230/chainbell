...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $DoubleCross_check_nD10$16, $DoubleCross_rollDiceCommand$17, $DoubleCross_parse_dx$18, $DoubleCross_parse_dx_od$19, $DoubleCross_parse_dx_shippu_doto$20, $DoubleCross_roll_emotion_table$21;
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var $nesting = [self].concat($parent_nesting), $DX_initialize$1, $DX_execute$2, $DX_node_expression$4, $DX_result_str$5, $DX_achieved_value_with_if_fumble$7, $DX_compare_result$8;
      ...
      Opal.def(self, '$execute', $DX_execute$2 = function $$execute(bot) {
        ...
        return self.$result_str(value_groups);
      ...
      Opal.def(self, '$result_str', $DX_result_str$5 = function $$result_str(value_groups) {
        var $$6, self = this, fumble = nil, sum = nil, achieved_value = nil, parts = nil;
      ...
      }, $DX_result_str$5.$$arity = 1);
      
      Opal.def(self, '$achieved_value_with_if_fumble', $DX_achieved_value_with_if_fumble$7 = function $$achieved_value_with_if_fumble(achieved_value, fumble) {
        var self = this;
      ...
      }, $DX_achieved_value_with_if_fumble$7.$$arity = 2);
      return (Opal.def(self, '$compare_result', $DX_compare_result$8 = function $$compare_result(achieved_value, fumble) {
        var self = this;
      ...
      }, $DX_compare_result$8.$$arity = 2), nil) && 'compare_result';
    })($nesting[0], null, $nesting);
    (function($base, $super, $parent_nesting) {
      var self = $klass($base, $super, 'ValueGroup');

      var $nesting = [self].concat($parent_nesting), $ValueGroup_initialize$9, $ValueGroup_to_s$10, $ValueGroup_max$11, $ValueGroup_num_of_critical_occurrences$13, $ValueGroup_critical$ques$15;
      ...
      Opal.def(self, '$initialize', $ValueGroup_initialize$9 = function $$initialize(values, critical_value) {
        var self = this;

        
        self.values = values.$sort();
        return (self.critical_value = critical_value);
      }, $ValueGroup_initialize$9.$$arity = 2);
      
      Opal.def(self, '$to_s', $ValueGroup_to_s$10 = function $$to_s() {
        var self = this;

        return "" + (self.$max()) + "[" + (self.values.$join(",")) + "]"
      }, $ValueGroup_to_s$10.$$arity = 0);
      
      Opal.def(self, '$max', $ValueGroup_max$11 = function $$max() {
        var $$12, self = this;

        if ($truthy($send(self.values, 'any?', [], ($$12 = function(value){var self = $$12.$$s || this;
          ...
          return self['$critical?'](value);}, $$12.$$s = self, $$12.$$arity = 1, $$12)))) {
          return 10
        } else {
          return self.values.$max()
        }
      }, $ValueGroup_max$11.$$arity = 0);
      
      Opal.def(self, '$num_of_critical_occurrences', $ValueGroup_num_of_critical_occurrences$13 = function $$num_of_critical_occurrences() {
        var $$14, self = this;

        return $send(self.values, 'select', [], ($$14 = function(value){var self = $$14.$$s || this;
          ...
          return self['$critical?'](value);}, $$14.$$s = self, $$14.$$arity = 1, $$14)).$length()
      }, $ValueGroup_num_of_critical_occurrences$13.$$arity = 0);
      self.$private();
      return (Opal.def(self, '$critical?', $ValueGroup_critical$ques$15 = function(value) {
        var self = this;

        return $rb_ge(value, self.critical_value)
      }, $ValueGroup_critical$ques$15.$$arity = 1), nil) && 'critical?';
    })($nesting[0], null, $nesting);
    
    Opal.def(self, '$check_nD10', $DoubleCross_check_nD10$16 = function $$check_nD10(total, _dice_total, dice_list, cmp_op, target) {
      var self = this;
    ...
    }, $DoubleCross_check_nD10$16.$$arity = 5);
    
    Opal.def(self, '$rollDiceCommand', $DoubleCross_rollDiceCommand$17 = function $$rollDiceCommand(command) {
      ...
      return nil;
    }, $DoubleCross_rollDiceCommand$17.$$arity = 1);
    self.$private();
    ...
    Opal.def(self, '$parse_dx', $DoubleCross_parse_dx$18 = function $$parse_dx(command) {
      var self = this, $case = nil;
      ...
      return nil;
    }, $DoubleCross_parse_dx$18.$$arity = 1);
    
    Opal.def(self, '$parse_dx_od', $DoubleCross_parse_dx_od$19 = function $$parse_dx_od(m) {
    ...
    }, $DoubleCross_parse_dx_od$19.$$arity = 1);
    
    Opal.def(self, '$parse_dx_shippu_doto', $DoubleCross_parse_dx_shippu_doto$20 = function $$parse_dx_shippu_doto(m) {
      ...
      target_value = ($truthy($a = m['$[]'](4)) ? m['$[]'](4).$to_i() : $a);
      return $$($nesting, 'DX').$new(num, critical_value, modifier, target_value);
    }, $DoubleCross_parse_dx_shippu_doto$20.$$arity = 1);
    
    Opal.def(self, '$roll_emotion_table', $DoubleCross_roll_emotion_table$21 = function $$roll_emotion_table() {
    ...
    }, $DoubleCross_roll_emotion_table$21.$$arity = 0);
